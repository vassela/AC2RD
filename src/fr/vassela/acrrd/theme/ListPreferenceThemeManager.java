/**
 * @file ListPreferenceThemeManager.java
 * @brief List preference theme manager class
...
public class ListPreferenceThemeManager extends ListPreference
{
	private ThemeManager themeManager = new ThemeManager();
	
	@TargetApi(Build.VERSION_CODES.M)
	public ListPreferenceThemeManager(Context context, AttributeSet attrs, int defStyle)
	{
		super(context, attrs, defStyle);
    }

	public ListPreferenceThemeManager(Context context, AttributeSet attrs)
	{
		super(context, attrs);
	}
