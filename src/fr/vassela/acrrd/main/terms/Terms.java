...
package fr.vassela.acrrd.main.terms;
...
public class Terms  extends Activity implements AppCompatCallback
{
	...
	private AppCompatDelegate delegate;
        ...
        public void onCreate(Bundle savedInstanceState)
        {
            ...
            delegate.setContentView(R.layout.terms);
            
            Toolbar toolbar = (Toolbar)findViewById(R.id.terms_toolbar);
	        delegate.setSupportActionBar(toolbar);
	        delegate.getSupportActionBar().setLogo(R.drawable.ic_dialog_alert);
	        delegate.setTitle(getApplicationContext().getString(R.string.terms_of_use));
